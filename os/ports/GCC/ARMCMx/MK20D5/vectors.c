...
/**
 * @file    GCC/ARMCMx/MK20D5/vectors.c
 * @brief   Interrupt vectors for the MK20D5 family.
 *
 * @defgroup ARMCMx_MK20D5_VECTORS MK20D5 Interrupt Vectors
 * @ingroup ARMCMx_SPECIFIC
 * @details Interrupt vectors for the MK20D5 family.
 * @{
 */
...
/**
 * @brief   Kinetis K20 vectors table.
 */
#if !defined(__DOXYGEN__)
